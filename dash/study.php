...
<div class="car-play-stage">
    ...
    <div class="car-play-canvas">
        ...
        <form id="study_form" method="post" action="<?= CAR_PATH_WEB ?>/dash/study-act">
        ...
        <div class="text-center text-secondary py-5">
            ...
            <a href="<?= CAR_PATH_WEB ?>/dash/deck-list" class="btn btn-outline-secondary btn-sm">
                <?= car_t($t, 'Decks') ?>
            </a>
        </div>
