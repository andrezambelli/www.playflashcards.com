...
<?php
	$header_title = car_t($t, 'common.contact-us.title') . ' - ' . car_t($t, 'Thanks') .  ' - Play Flashcards';
	$header_description = '';
...
<div class="div-primary">
    <div class="div-start">
        <h1><?= car_t($t, 'common.contact-us.title') . ' - ' . car_t($t, 'Thanks'); ?></h1>
        <?= car_t($t, 'common.contact-us-thanks.message1'); ?><br/>
        <br/>
        <?= car_t($t, 'common.contact-us-thanks.message2'); ?><br/>
        <div class="social">
