...
<?php
    ...
    if(isset($_GET['page'])) {
        ...
        $sql = sprintf(" 
                        select b.deck_id, b.deck_key, b.deck_name, b.deck_desc, b.deck_color, b.deck_bgcolor, a.stud_id, a.stud_begin, a.stud_end, a.stud_total, a.stud_true, a.stud_false, a.stud_public
        ...
        if ($has_study and !$has_card and empty($stud_end)) { // Não tem novo flashcard para responder e o estudo  ainda não tem data de fim
